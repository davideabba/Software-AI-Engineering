...
source: "https://academy.langchain.com/courses/take/foundation-introduction-to-langchain-python/texts/71234844-getting-set-up-text"
author:
  - "LangChain Academy"
published:
created: 2026-04-30
description: "Foundation: Introduction to LangChain - Python - LangChain Academy"
tags:
  - "langchain"
---
### Getting Set Up (Text)
...
![Course Banner](https://files.cdn.thinkific.com/file_uploads/967498/images/968/cf7/461/Generic_Course_Banner.png)
...
ImportError when running env\_utils.py
...
If you see “LANGSMITH\_TRACING is enabled but LANGSMITH\_API\_KEY still has the example/placeholder value”, you need to either:
...
Using uv (recommended) `uv` will install a version of Python compatible with the versions specified in the `pyproject.toml` in the `.venv` directory when running the `uv sync` specified above. It will use this version when invoking with `uv run`. For additional information, please see [uv](https://docs.astral.sh/uv/). Using pyenv + pip
...
![LangSmith Dashboard](https://github.com/user-attachments/assets/e39b8364-c3e3-4c75-a287-d9d4685caad5)

![LangSmith API Keys](https://github.com/user-attachments/assets/2e916b2d-e3b0-4c59-a178-c5818604b8fe)

- Update the.env file you created with your new LangSmith API Key.
- Check that LANGSMITH\_TRACING is uncommented and set to true.
